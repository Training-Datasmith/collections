 ...
 */
abstract class Abstract_Lazy_Collection implements Collection, Selectable
{
    /**
    ...
    {
        $this->initialize();
        return $this->collection->is_empty();
    }
    #[Override]
    ...
    {
        $this->initialize();
        return $this->collection->remove_element($element);
    }
    #[Override]
    public function contains_key(string|int $key): bool
    {
        $this->initialize();
        return $this->collection->contains_key($key);
    }
    #[Override]
    ...
    {
        $this->initialize();
        return $this->collection->get_keys();
    }
    #[Override]
    public function get_values(): array
    {
        $this->initialize();
        return $this->collection->get_values();
    }
    #[Override]
    ...
    {
        $this->initialize();
        return $this->collection->to_array();
    }
    #[Override]
    ...
    {
        $this->initialize();
        return $this->collection->find_first($p);
    }
    #[Override]
    ...
    {
        $this->initialize();
        return $this->collection->for_all($p);
    }
    #[Override]
    ...
    #[Override]
    public function index_of(mixed $element): string|int|false
    {
        $this->initialize();
        return $this->collection->index_of($element);
    }
    #[Override]
     ...
     */
    abstract protected function do_initialize(): void;
    #[Override]
